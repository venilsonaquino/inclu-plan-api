...
describe('InMemoryStudentsRepository', () => {
  ...
  it('should create and retrieve by id', async () => {
    const student = new Student({ id: '1', name: 'John', gradeId: 'g1', profiles: [] });
  ...
  it('should retrieve by classId', async () => {
    await repository.create(new Student({ id: '1', schoolClassId: 'c1', name: 'A', gradeId: '1', profiles: [] }));
    await repository.create(new Student({ id: '2', schoolClassId: 'c1', name: 'B', gradeId: '1', profiles: [] }));
    await repository.create(new Student({ id: '3', schoolClassId: 'c2', name: 'C', gradeId: '1', profiles: [] }));
